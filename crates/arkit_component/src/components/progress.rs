...
use crate::appearance::{ProgressAppearance, ProgressStyleInput};
...
pub struct ProgressProps {
    ...
    /// Concrete paint from a style crate. When set, kit defaults are ignored.
    #[props(default)]
    pub appearance: Option<ProgressAppearance>,
...
pub fn Progress(props: ProgressProps) -> Element {
    ...
    let appearance = props.appearance.unwrap_or_else(|| {
        kit.progress(&ProgressStyleInput {
            height: props.height,
    ...
    let indicator_color = appearance.indicator_color;
