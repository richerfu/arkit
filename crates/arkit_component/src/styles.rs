//! Shared token-driven helpers for Dioxus components.
//! Visual values come from a [`Theme`] resolved by [`crate::style::use_theme`].

use crate::style::{spacing, typography, Theme};
use arkit_prelude::*;
...
pub fn alpha(color: u32, a: u8) -> u32 {
    crate::style::with_alpha(color, a)
}
