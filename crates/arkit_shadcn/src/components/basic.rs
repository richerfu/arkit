...
pub fn button(label: impl Into<String>, variant: ButtonVariant) -> ButtonElement {
    ...
    match variant {
        ButtonVariant::Default => shadow_sm(
            base.background_color(color::PRIMARY)
        ...
        ButtonVariant::Secondary => shadow_sm(
            base.background_color(color::SECONDARY)
                .style(
        ...
        ButtonVariant::Outline => shadow_sm(
            base.background_color(color::BACKGROUND)
        ...
        ButtonVariant::Destructive => shadow_sm(
            base.background_color(color::DESTRUCTIVE)
                .style(
                    ArkUINodeAttributeType::FontColor,
...
pub fn icon_button(icon: impl Into<String>) -> ButtonElement {
    button(icon, ButtonVariant::Outline)
        .width(40.0)
        .height(40.0)
