...
pub mod prelude {
    ...
    pub use arkit::{
        back_route, component, current_route, entry, push_route, register_named_route,
        ...
        use_router, use_signal, Element, LifecycleEvent, Route, RouteDefinition, Router, Signal,
    };
}
