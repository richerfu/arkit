...
#   example-dir: counter | async_task | animation | barcode | camera | canvas | chart | complex_cases | i18n | lottie | router | shadcn_showcase | colorui_showcase | terminal | webview
#
