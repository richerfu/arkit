//! ColorUI showcase — same pages and demos as shadcn_showcase, ColorUI paint.
...
use arkit::colorui::components::{
    ...
    FieldContent, FieldDescription, FieldError, FieldGroup, FieldLegend, FieldOrientation,
    FieldSeparator, FieldSet, FieldTitle, Form, FormItem, Guide, GuideSide, GuideStep, GuideTarget,
    HoverCard, InfiniteScroll, Input, InputMode, InputOtp, InputOtpMode, InputOtpSeparator, Label,
...
use arkit::colorui::theme::{use_colorui, use_theme, ColorUiTheme};
use arkit::colorui::PaletteColor;
use arkit::component::icon::icon_placeholder;
use arkit::component::style::{
    spacing, typography, use_token_provider, with_alpha, Theme, ThemeMode,
};
...
./app/run.sh colorui_showcase all
```
"#;
...
const THEME_PRESETS: [PaletteColor; 7] = [
    PaletteColor::Green,
    PaletteColor::Blue,
    PaletteColor::Cyan,
    PaletteColor::Purple,
...
fn app() -> Element {
    ...
    let state = ShowcaseState {
        ...
        preset: use_signal(|| PaletteColor::Green),
    ...
    let _ = use_colorui(theme);
    let _ = use_token_provider(theme.tokens());
...
fn resolve_theme(mode: ThemeMode, preset: PaletteColor, custom: bool) -> ColorUiTheme {
    let primary = if custom { PaletteColor::Cyan } else { preset };
    ColorUiTheme::new(primary, mode)
}
...
fn HomeView(
    ...
    on_preset: EventHandler<PaletteColor>,
...
fn ComponentListItem(
    ...
    let row_background = with_alpha(theme.colors.secondary, 0x66);
    let row_border = with_alpha(theme.colors.foreground, 0x0D);
    let icon_color = with_alpha(theme.colors.foreground, 0x80);
                        ...
                        column {
                            ...
                            Slider {
                                ...
                                style: SliderStyle {
                                    ...
                                    track_color: Some(with_alpha(theme.colors.chart_1, 0x33)),
                                    ..SliderStyle::default()
                                },
                        ...
                        column {
                            ...
                            Slider {
                                ...
                                style: SliderStyle {
                                    ...
                                    track_color: Some(with_alpha(theme.colors.chart_2, 0x33)),
                                    ..SliderStyle::default()
                                },
...
fn theme_preset_key(preset: PaletteColor) -> &'static str {
    match preset {
        ...
        PaletteColor::Olive => "olive",
        other => match other {
            PaletteColor::Yellow => "yellow",
            PaletteColor::Pink => "pink",
            PaletteColor::Mauve => "mauve",
...
fn theme_preset_label(preset: PaletteColor) -> &'static str {
    match preset {
        PaletteColor::Green => "Green",
        PaletteColor::Blue => "Blue",
        PaletteColor::Cyan => "Cyan",
